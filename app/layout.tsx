...
export const metadata: Metadata = {
  title: "Tobias Dunn",
  description:
    "Security Consultant and penetration tester with OSCP+ certification. Portfolio of CTF walkthroughs, blog posts, and projects.",
};
...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <body
        className={`${geistSans.variable} ${geistMono.variable} ${geistMono.className} bg-background flex flex-col antialiased max-w-screen`}
      >
        <Navbar />
