...
const OSCPExperience = () => {
  ...
  <h2 className="text-xl font-semibold my-3 text-secondary">Final Push Before the Exam</h2>
  ...
  <h2 className="text-xl font-semibold my-3 text-secondary">My Exam Strategy and Execution</h2>
  ...
  <h3 className="text-lg font-medium my-2 text-secondary">What I Achieved</h3>
  ...
  <h2 className="text-xl font-semibold my-3 text-secondary">Lessons Learned the Hard Way</h2>
  <h3 className="text-lg font-medium my-2 text-secondary">Don’t Trust Your Tools Blindly</h3>
  ...
  <h3 className="text-lg font-medium my-2 text-secondary">Don’t Tunnel Vision</h3>
  ...
  <h2 className="text-xl font-semibold my-3 text-secondary">Tools &amp; Tips That Made a Difference</h2>
  <h3 className="text-lg font-medium my-2 text-secondary">Ligolo-ng</h3>
  ...
  <h3 className="text-lg font-medium my-2 text-secondary">script</h3>
  ...
  <h2 className="text-xl font-semibold my-3 text-secondary">Reporting</h2>
  ...
  <h2 className="text-xl font-semibold my-3 text-secondary">Passing and Looking Ahead</h2>
  ...
  <h2 className="text-xl font-semibold my-3 text-secondary">Final Thoughts &amp; Advice</h2>
